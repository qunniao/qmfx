                    ...
                    <el-col :span="16">
                        <div>订单信息</div>
                            <div style="padding-left:20px">
                                <div>下单人：{{orderdetail.nickname}}</div>
                                <div>配送方式：{{sendway[orderdetail.deliveryWay]}}</div>
            ...
            this.tableLoading = true;
             getOrderDetailAPI(id)
                .then(res => {
                    ...
                    this.orderProductVOList=orderdata.orderProductVOList
                })
                .catch(err => {
